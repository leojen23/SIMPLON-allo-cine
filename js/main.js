const filmData = [
    ...
    },
    {
      ...
      "Poster": "https://m.media-amazon.com/images/M/MV5BYTE1ZTBlYzgtNmMyNS00ZTQ2LWE4NjEtZjUxNDJkNTg2MzlhXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_UX182_CR0,0,182,268_AL_.jpg",
      "Metascore": "65",
      "imdbRating": "7.2",
      "Type": "movie",
      "Images": [
    ...
    },
    {
      ...
      "Poster": "https://m.media-amazon.com/images/M/MV5BMjAzNTkzNjcxNl5BMl5BanBnXkFtZTYwNDA4NjE3._V1_UX182_CR0,0,182,268_AL_.jpg",
      "Metascore": "52",
      "imdbRating": "7.7",
      "Type": "movie",
      "Images": [
    ...
    },
    {
      ...
      "Poster": "https://m.media-amazon.com/images/M/MV5BMjIxMjgxNTk0MF5BMl5BanBnXkFtZTgwNjIyOTg2MDE@._V1_UX182_CR0,0,182,268_AL_.jpg",
      "Metascore": "75",
      "imdbRating": "8.2",
      "Type": "movie",
      "Images": [
    ...
    },
    {
      ...
      "Poster": "https://m.media-amazon.com/images/M/MV5BMjA5NzA5NjMwNl5BMl5BanBnXkFtZTgwNjg2OTk2NzM@._V1_UX182_CR0,0,182,268_AL_.jpg",
      "Metascore": "N/A",
      "imdbRating": "9.5",
      "Type": "series",
      "totalSeasons": "7",
    ...
    },
    {
      ...
      "Poster": "https://m.media-amazon.com/images/M/MV5BNDYyNzk1NzYwOF5BMl5BanBnXkFtZTgwMTQ0Nzc4MzI@._V1_UY268_CR8,0,182,268_AL_.jpg",
      "Metascore": "N/A",
      "imdbRating": "8.6",
      "Type": "series",
      "totalSeasons": "5",
    ...
    },
    {
      ...
      "Poster": "https://m.media-amazon.com/images/M/MV5BMTU5NjQ2MTU4NV5BMl5BanBnXkFtZTgwOTYyNTAwNzM@._V1_UY268_CR16,0,182,268_AL_.jpg",
      "Metascore": "N/A",
      "imdbRating": "8.0",
      "Type": "series",
      "totalSeasons": "3",
    ...
    },
    {
      ...
      "Poster": "https://m.media-amazon.com/images/M/MV5BMjQ0MjI5NTEzNF5BMl5BanBnXkFtZTgwMTk4NzQ0NTM@._V1_UX182_CR0,0,182,268_AL_.jpg",
      "Metascore": "N/A",
      "imdbRating": "8.0",
      "totalSeasons": "3",
        "Images": [
    ...
    },
    {
      ...
      "Poster": "https://m.media-amazon.com/images/M/MV5BNmFjODU3YzgtMGUwNC00ZGI3LWFkZjQtMjkxZDc3NmQ1MzcyXkEyXkFqcGdeQXVyNjUwNzk3NDc@._V1_UX182_CR0,0,182,268_AL_.jpg",
      "Metascore": "N/A",
      "imdbRating": "8.9",
      "Type": "series",
      "totalSeasons": "2",
    ...
    },
    {
      ...
      "Country": "USA",
      "Awards": "N/A",
      "Poster": "https://m.media-amazon.com/images/M/MV5BNjgwNzAzNjk1Nl5BMl5BanBnXkFtZTgwMzQ2NjI1OTE@._V1_UX182_CR0,0,182,268_AL_.jpg",
      "Metascore": "72",
      "imdbRating": "7.5",
      "Images": [
    ...
    },
    {
      ...
      "Awards": "N/A",
      "Poster": "https://m.media-amazon.com/images/M/MV5BNzE1OTczNTc1OF5BMl5BanBnXkFtZTgwMzgyMDI3MDI@._V1_UX182_CR0,0,182,268_AL_.jpg",
      "Metascore": "36",
      "imdbRating": "5.8",
      "Images": [
  ...
  function filmTemplate(film){
    return `
    <div class="row filmCard" id="filmCard">

        <div class="col-sm-12 col-lg-3 poster" id="poster" >
            <a href="#"><img src="${film.Poster}" alt=""></a> 
        </div>
        
            
        <div class="info-holder col-lg-9">
            <h2 id="title"> ${film.Title}</h2>
            <h4 id="Year"><span>Year : </span> ${film.Year}</h4>
            <h4 id="Released"><span>Released : </span> ${film.Released}</h4>
            <h4 id="Runtime"><span>Runtime : </span> ${film.Runtime}</h4>
            <h4 id="Genre"><span>Genre :</span> ${film.Genre}</h4>
            <h4 id="Director"><span>Director :</span> ${film.Director}</h4>
            <h4 id="Writer"><span>Writer :</span> ${film.Writer}</h4>
            <h4 id="Actors"><span>Actors :</span> ${film.Actors}</h4>
            <h4 id="Plot"><span>Plot :</span> ${film.Plot}</h4>
            <h4 id="Language"><span>Language :</span> ${film.Language}</h4>
            <h4 id="Country"><span>Country :</span> ${film.Country}</h4>
            <h4 id="Awards"><span>Awards :</span> ${film.Awards}</h4>
            <h4 id="Metascore"><span>Metascore :</span> ${film.Metascore}</h4>
            <h4 id="Type"><span>Type :</span> ${film.Type}</h4>
            <div class="xinfo-holder">
            
            <h3 id="Rating">Rating: ${film.imdbRating}</h3>
            <div class="image-holder">
                <a href=""><img id="pics" src="${film.Images[0]}" alt=""></a>
                <a href=""><img id="pics" src="${film.Images[1]}" alt=""></a>
                <a href=""><img id="pics" src="${film.Images[2]}" alt=""></a>
            </div>
            </div>
        </div>
...
document.getElementById("container").innerHTML = `
    ${filmData.map(filmTemplate).join('')} 
    `
